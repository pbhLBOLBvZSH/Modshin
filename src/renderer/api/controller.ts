...
export const controller: GeneralController = {
    ...
    getSyncPlayList(args) {
        return apiController('getSyncPlayList', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayBuffering(args) {
        return apiController('postSyncPlayBuffering', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayJoin(args) {
        return apiController('postSyncPlayJoin', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayLeave(args) {
        return apiController('postSyncPlayLeave', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayNew(args) {
        return apiController('postSyncPlayNew', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayNextItem(args) {
        return apiController('postSyncPlayNextItem', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayPause(args) {
        return apiController('postSyncPlayPause', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayPing(args) {
        return apiController('postSyncPlayPing', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayQueue(args) {
        return apiController('postSyncPlayQueue', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayReady(args) {
        return apiController('postSyncPlayReady', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlaySeek(args) {
        return apiController('postSyncPlaySeek', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlaySetRepeatMode(args) {
        return apiController('postSyncPlaySetRepeatMode', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayStop(args) {
        return apiController('postSyncPlayStop', args.apiClientProps.server?.type)?.(args);
    },
    postSyncPlayUnpause(args) {
        return apiController('postSyncPlayUnpause', args.apiClientProps.server?.type)?.(args);
    },
};
